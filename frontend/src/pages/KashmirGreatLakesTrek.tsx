...
const vendors = [
  {
    ...
    highlights: [
      ...
      { text: 'Premium Camping', color: 'bg-purple-100 text-purple-800' },
      { text: 'Photography Guide', color: 'bg-green-100 text-green-800' },
    ],
  },
  {
    id: 2,
    name: 'Himalayan Lakes',
    logo: 'HL',
  ...
  },
  {
    ...
    highlights: [
      ...
      { text: 'Gourmet Food', color: 'bg-orange-100 text-orange-800' },
    ],
  },
  {
    id: 4,
    name: 'Kashmir Trekkers',
    logo: 'KT',
...
const KashmirGreatLakesTrek = () => {
  ...
  const quickFacts = [
    { label: 'Region', value: 'Kashmir Valley', icon: '🗺️' },
    { label: 'Altitude', value: '13,750 ft / 4,190 m', icon: '📏' },
    { label: 'Duration', value: '7-8 Days', icon: '⏳' },
    { label: 'Season', value: 'July to September', icon: '🌤️' },
    { label: 'Difficulty', value: 'Moderate to Difficult', icon: '⚠️' },
    { label: 'Trail Distance', value: '72 km approx.', icon: '🥾' },
    { label: 'Start/End Point', value: 'Sonamarg', icon: '📍' },
  ...
  const howToReach = [
    {
      ...
      icon: '✈️',
      detail:
        'Nearest airport is Sheikh ul-Alam Airport, Srinagar. Taxis available to Sonamarg.',
    },
    {
      mode: 'By Train',
      icon: '🚆',
      detail:
        'Nearest railway station is Jammu Tawi (400 km). Take a taxi/bus to Srinagar.',
    },
    {
      mode: 'By Bus',
      icon: '🚌',
      detail:
        'Regular buses from Srinagar to Sonamarg. Private taxis also available.',
    },
    {
      mode: 'By Road',
      icon: '🚗',
      detail: 'Well-connected road network from Srinagar to Sonamarg via NH-1.',
    },
  ];
        ...
        <div className="mx-auto max-w-6xl px-4 py-8 pt-24 pb-12">
          ...
          <div className="flex flex-col gap-6 md:flex-row">
            ...
            <div className="space-y-3 md:w-1/2">
              ...
              <p className="text-gray-200">📍 Sonamarg, Kashmir Valley</p>
              <p className="text-sm text-gray-300">
                The Kashmir Great Lakes Trek is one of India's most beautiful
                alpine lake treks. This moderate to difficult trek takes you
                through seven alpine lakes, each uniquely beautiful, set against
                the backdrop of towering peaks and endless meadows.
              </p>
              ...
              {activeTab === 'Overview' && (
                <div className="rounded-lg bg-white p-6">
                  ...
                  <p className="mt-3 text-gray-600">
                    The Kashmir Great Lakes Trek is a journey through some of
                    the most pristine and untouched landscapes in the Himalayas.
                    The trek takes you through seven different alpine lakes,
                    each with its own unique character and beauty.
                  </p>
                  <p className="mt-3 text-gray-600">
                    Along the way, you'll traverse through vast meadows, cross
                    glacial valleys, and witness the raw beauty of the Kashmir
                    Himalayas. The trek offers stunning views of prominent peaks
                    and the chance to spot rare Himalayan wildlife.
                  </p>
                  ...
                  <div className="mt-4 space-y-4 rounded-lg bg-gray-50 p-6 shadow-md">
                    <div>
                      ...
                      <p className="text-gray-600">
                        Rocky terrain, moraines, and steep ascents. Multiple
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Good physical fitness needed. Prior trekking experience
                        recommended.
                      </p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Experienced trekkers and fit beginners with proper
                        preparation.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 grid gap-6 md:grid-cols-2">
                    <div className="space-y-3">
                      ...
                      <ul className="list-inside list-disc text-gray-600">
                        <li>Follow acclimatization schedule strictly</li>
                        <li>Stay hydrated and well-rested</li>
                        <li>Report any altitude sickness symptoms</li>
                      </ul>
                    </div>
                    <div className="space-y-3">
                      <h4 className="font-medium text-gray-700">Essentials</h4>
                      <ul className="list-inside list-disc text-gray-600">
                        <li>Quality trekking gear and boots</li>
                        <li>Warm layers and rain protection</li>
                        <li>First aid and altitude sickness medication</li>
                      </ul>
                    </div>
                  </div>
                </div>
          ...
          <div className="mt-10 rounded-xl bg-white p-6">
            <div className="mb-6">
              ...
              <p className="mt-2 text-gray-600">
                Choose from verified trekking companies offering Kashmir Great
                Lakes packages
              </p>
            </div>
...
export default KashmirGreatLakesTrek;
