      ...
      <div className="space-y-8">
        ...
        >
          {Array.from({ length: 3 }).map((_, index) => (
            <div key={index} className="w-96 h-[480px] bg-gray-200 rounded-xl shadow-md animate-pulse">
    ...
    <div className="space-y-8">
      ...
      >
        {eventsData && eventsData.events && eventsData.events.length > 0 ? (
          ...
          <div className="w-96 h-[480px] bg-gray-100 rounded-xl shadow-md flex items-center justify-center border-2 border-dashed border-gray-300">
