    ...
    <>
      ...
      <div className={`fixed inset-0 z-50 flex items-center justify-center p-4 ${
        ...
        <div className={`relative w-full max-w-md bg-white rounded-2xl shadow-2xl transform transition-all duration-200 ${
          ...
          <div className="p-8">
            {/* Title */}
            <h2 className="font-tpc text-2xl font-bold text-gray-800 text-center mb-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-[#1E63EF] hover:bg-[#E31E56] text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
              >
                {isSignUp ? 'Create Account' : 'Login'}
              </button>
            </form>
            ...
            <button
              ...
              className="w-full bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-3 px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-3 transform hover:scale-[1.02] active:scale-[0.98]"
            >
