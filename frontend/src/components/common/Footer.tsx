...
const Footer = () => {
  return (
    <div className="font-tpc relative flex flex-col gap-8 bg-[#1E63FE] p-8 text-white">
      {/* Logo */}
      ...
      <div className="flex gap-x-60">
        ...
        {/* Meet us Outdoors */}
        <div className="flex flex-col gap-2">
          <div className="font-bold">Meet us outdoors</div>
          <div className="flex flex-col gap-2">
            <img
              src={googlePlay}
      ...
      <div className="flex items-center gap-1">
        ...
        <span className="flex items-center justify-center">•</span>
        <span>
          registered trademarks of Mounterra, LLC in India as well as certain
          other jurisdictions
        </span>
      </div>

      <div className="absolute top-0 right-0 h-80">
        <img
          src={footerDecal}
          alt="Google Play Store"
